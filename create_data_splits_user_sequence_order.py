...
df_train.to_csv("../../data/user_sequence_words" + '/train.csv', index=False)
df_val.to_csv("../../data/user_sequence_words" + '/valid.csv', index=False)
df_test.to_csv("../../data/user_sequence_words" + '/test.csv', index=False)
