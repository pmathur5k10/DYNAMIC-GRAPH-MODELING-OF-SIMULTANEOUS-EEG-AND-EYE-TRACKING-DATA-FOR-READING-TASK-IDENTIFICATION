...
N_LAYERS=2
MAX_SIZE_VOCAB=3890
PATH="./saved_models/best_model_sentence"
...
train, valid, test = TabularDataset.splits(path="../../../data/sentence_sequence_words", train='train.csv', validation='valid.csv', test='test.csv',
